...
28 hand-written scenarios, one failure class each, scored from the trace file and the twin end state only. Plus 27 generated scenarios: every write operation crossed with a 500, a rate limit and a silent no-op, asserting only the invariants.

| Class | Failure | Baseline | Final |
|---|---|---|---|
| H | Happy path | 6/6 | 6/6 |
| F1 | Identity mis-resolution | 3/3 | 3/3 |
